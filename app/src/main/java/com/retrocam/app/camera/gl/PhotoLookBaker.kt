...
object PhotoLookBaker {
    ...
    fun bake(context: Context, source: Bitmap, look: RenderLook): Bitmap {
        ...
        try {
            ...
            val uColorChromeWarmLoc = GLES20.glGetUniformLocation(program, "uColorChromeWarm")
            val uColorChromeBlueLoc = GLES20.glGetUniformLocation(program, "uColorChromeBlue")
